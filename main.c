...
printf("\t \t  |___/ |_|_\\  \\___/ |_|  |_| \\___/ |___/  \n");
    ...
    FILE *fptr;
    if(city==1)
        fptr=fopen("inputs/input.txt","r");
    else if(city==2)
        fptr=fopen("inputs/input_2.txt","r");
    else if(city==3)
        fptr=fopen("inputs/input_3.txt","r");
    else if(city==4)
        fptr=fopen("inputs/input_4.txt","r");
    else if(city==5)
        fptr=fopen("inputs/input_5.txt","r");
    else{
        printf("Invalid city!\n"); 
        fflush(0); 
